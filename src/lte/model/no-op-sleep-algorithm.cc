...
void
NoOpSleepAlgorithm::DoReportSleepCellRsrp (uint16_t rnti, LteRrcSap::MeasResults measResults)
{
    NS_LOG_FUNCTION (this);
}
...
void
NoOpSleepAlgorithm::DoReportSleepSpectrumEfficiency (uint16_t cellId, LteRrcSap::SeResults seResults)
{
    NS_LOG_FUNCTION (this);
}
